...
function checkForCollisions() {
    for (let i = 0; i < blocks.length; i++){
        ...
        (
          ...
          ((currentBallPosition[1] + ballDiametre) > blocks[i].bottomLeft[1] && currentBallPosition[1] < blocks[i].topLeft[1]) 
        )
          {
    ...
    if(currentBallPosition[0] >= (boardWidth - ballDiametre) || currentBallPosition[1] >= (boardHeight - ballDiametre) || currentBallPosition[0] <= 0){
        changeDirection()
    }
